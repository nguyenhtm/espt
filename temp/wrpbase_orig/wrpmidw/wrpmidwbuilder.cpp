...
void WrpMidwBuilder::BuildDiagnosis()
{
   WRPPRINT("%s\n", "WrpMidwBuilder::BuildDiagnosis() Begin");
   WRPPRINT("%s\n", "WrpMidwBuilder::BuildDiagnosis() End");
}
...
void WrpGuiMidwBuilder::BuildDiagnosis()
{
   WRPPRINT("%s\n", "WrpGuiMidwBuilder::BuildDiagnosis() Begin");
   WrpSys::WrpDiagnosis::WrpDiagnosis::Instance()->SelfDiagnosis();
   WRPPRINT("%s\n", "WrpGuiMidwBuilder::BuildDiagnosis() End");
}
